...
/**
 * 認識結果の候補全体に対するフィードバック画面 認識結果の候補全体に対するフィードバックを実行するサンプルページ
 */
public class FeedbackToCandidateActivity extends Activity implements OnClickListener {
	...
	private class FeedbackToCandidateAsyncTask
			extends AsyncTask<ImageRecognitionFeedbackToCandidateRequestParam, Integer, Boolean> {
	...
	private void pushExecButton() {
		...
		ImageRecognitionFeedbackToCandidateRequestParam requestParam = new ImageRecognitionFeedbackToCandidateRequestParam();
